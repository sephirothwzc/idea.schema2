...
def generate(out, className, fields ,tablename) {
    ...
    out.println "               <button type=\"submit\" class=\"btn btn-primary\" ms-class=\"@isread.readonly?'none':''\">{{@vmtag.btnsave}}</button>"
    out.println "               &nbsp;&nbsp;"
    out.println "               <button type=\"reset\" class=\"btn btn-primary\" ms-on-click=\"closeTab\">{{@vmtag.btncancel}}</button>"
    out.println "           </div>"
